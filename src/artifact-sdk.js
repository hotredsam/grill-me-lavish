...
export function createArtifactSdk(
  ...
  function highlightElement(el) {
    if (!el) return;
    el.style.outline = "var(--lavish-annotate-outline,2px solid oklch(0.52 0.18 18))";
